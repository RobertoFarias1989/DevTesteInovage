        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryAdress = table.Column<string>(type: "nvarchar(254)", maxLength: 254, nullable: false),
                    RegisteredAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateredAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PurchaseItems_Purchases_IdPurchase",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseItems_IdPurchase",
                table: "PurchaseItems",
                column: "IdPurchase");
        }
